---
timestamp: 'Sat Oct 18 2025 21:59:47 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251018_215947.4557985c.md]]'
content_id: 9ab92a78c972d6fcf5e88645d121fb33e69cae40cd52eb5ade3dfe373bb708b8
---
  ...
  async createProblem(
    {
      ...
      grade: string;
      holds: string[];
      movementTypes?: string[]; // Made optional, defaults to empty array if not provided
      board: Board;
      setter: User;
    },
